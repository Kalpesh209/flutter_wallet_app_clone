      ...
      child: Column(
        children: [
          Row(
            ...
            children: [
              textstyle('Income Stats', AppColors.darkpurple0, 18),
              Container(
                ...
                child: Row(
                  children: [
                    textstyle('Oct-Feb', AppColors.grey, 15),
                    Icon(
                        ...
                        return lineBarSpots.map((LineBarSpot lineBarSpot) {
                          ...
                          if (spot.x == 0) {
                            ...
                            return LineTooltipItem(
                                'Unknown', TextStyle(color: AppColors.white));
                          }
                        }).toList();
          ...
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              textstyle('Oct', AppColors.grey, 18),
              textstyle('Nov', AppColors.grey, 18),
              textstyle('Dec', AppColors.grey, 18),
              textstyle('Jan', AppColors.grey, 18),
            ],
          )
        ],
      ),
